...
public class DateUtils {
  ...
  public static List<LocalDate> getAllSundayForBalancing(final LocalDate dateFrom,
  ...
  public static LocalDate dateTimeToLocalDate(final DateTime dateTime) {
    return Instant.ofEpochMilli(dateTime.getTimestamp()).atZone(ZoneId.systemDefault())
        .toLocalDate();
  }

  public static List<LocalDate> getLocalDatesFromTo(final LocalDate fromDate,
  ...
  public static LocalDate getLastDateBefore(final LocalDate date,
      final List<LocalDate> localDates) {
  ...
  public static LocalDate getFirstDateAfter(final LocalDate date,
      final List<LocalDate> localDates) {
    localDates.sort(null);
    for (final LocalDate localDate : localDates) {
